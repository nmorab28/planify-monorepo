                  ...
                  <div className="profile-news">
                    <div className="media pt-3 pb-3">
                      ...
                      <div className="media-body">
                        <h5 className="m-b-5">
                          <Link to="/post-details">These Mistakes Will Destroy Your EDUCATION</Link>
                        </h5>
                        <p className="mb-0">
                    ...
                    <div className="media pt-3 pb-3">
                      ...
                      <div className="media-body">
                        <h5 className="m-b-5">
                          <Link to="/post-details">Best 50 Tips For Eduction</Link>
                        </h5>
                        <p className="mb-0">
                          I shared this on my fb wall a few months back, and I thought.
                        </p>
                        ...
                        <div className="my-post-content pt-3">
                          ...
                          <div className="profile-uoloaded-post border-bottom-1 pb-5">
                            ...
                            <p>
                              ...
                              has take possession of my entire soul like these sweet morning of
                              spare which enjoy whole heart.
                            </p>
