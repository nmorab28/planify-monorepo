...
const PostDetails = () => {
  ...
  return (
    <div>
      <div>
        <PageTitle activeMenu="Post Details" motherMenu="Advanced" pageContent="Post Details" />
        {/* row */}
        <div className="row">
                        ...
                        <div className="modal-content">
                          <div className="modal-header">
                            ...
                            <Button
                              ...
                              className="close"
                              data-dismiss="modal"
                              onClick={() => dispatch({ type: 'sendMessageClose' })}
                            >
                              <span>×</span>
                            </Button>
                          </div>
                              ...
                              <div className="row">
                                <div className="col-lg-6">
                                  <div className="form-group mb-3">
                                    <label htmlFor="author" className="font-w600">
                                      {' '}
                                ...
                                <div className="col-lg-12">
                                  <div className="form-group mb-3">
                                    <label htmlFor="comment" className="font-w600">
                                      Comment
                                    </label>
                                    <textarea
                                      rows={8}
                  ...
                  <div className="card-body pt-3">
                    <div className="profile-blog ">
                      ...
                      <Link to="/post-details">
                        {' '}
                        <h4>Proof that Education is exactly what you are looking for</h4>{' '}
                      </Link>
                      <p className="mb-0">
                  ...
                  <div className="card-body pt-3">
                    <div className="profile-news">
                      ...
                      <div className="media pt-3 pb-3">
                        ...
                        <div className="media-body">
                          <h5 className="m-b-5">
                            <Link to="/post-details">Best 50 Tips For EDUCATION</Link>
                          </h5>
                          <p className="mb-0">
                            I shared this on my fb wall a few months back, and I thought.
                          </p>
                      ...
                      <div className="media pt-3 ">
                        ...
                        <div className="media-body">
                          <h5 className="m-b-5">
                            <Link to="/post-details">EDUCATION: This Is What Professionals</Link>
                          </h5>
                          <p className="mb-0">
                            I shared this on my fb wall a few months back, and I thought.
                          </p>
            ...
            <div className="card">
              <div className="card-body">
                <div className="post-details">
                  <h3 className="mb-2">How To Get (A) Fabulous EDUCATION On A Tight Budget</h3>
                  ...
                  <div className="profile-skills mt-5 mb-5">
                    ...
                    <Link to="/post-details" className="btn btn-primary light btn-xs mb-1 me-1">
                      Admin
                    </Link>
                    <Link to="/post-details" className="btn btn-primary light btn-xs mb-1 me-1">
                      Dashboard
