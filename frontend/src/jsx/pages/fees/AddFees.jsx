              ...
              <form action="#" method="post">
                <div className="row">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Ammount">
                        Ammount
                      </label>
                      <input
                        placeholder="Ammount"
                  ...
                  <div className="col-sm-6">
                    <div className="form-group mb-4">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Collection Date" className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Payment_Reference_Number">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Payment_Details">
                        Payment Details
                      </label>
                      <textarea
