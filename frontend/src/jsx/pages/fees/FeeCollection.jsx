...
const FeeCollection = () => {
  ...
  const [data, setData] = useState(document.querySelectorAll('#feeList tbody tr'));
  //   const sort = 10
                    ...
                    <tbody>
                      {feeData.map((data, ind) => (
                        <tr key={ind}>
                          ...
                          <td>{data.payment}</td>
                          <td>
                            <span className={`badge badge-${data.color}`}>{data.status}</span>
                          </td>
                          <td>{data.date}</td>
                          <td>
