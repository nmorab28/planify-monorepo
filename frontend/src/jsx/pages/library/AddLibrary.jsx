            ...
            <div className="card-body">
              <form>
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Auther_Name">
                        Auther Name
                      </label>
                      <input
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Purchase Date" className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Assets_Details">
                        Assets Details
                      </label>
                      <textarea
