        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div
                  className={`col-xl-3 col-xxl-4  email-left-body ${openMailBar ? 'active' : ' '}`}
                >
                  <div className="email-left-box generic-width px-0 mb-5">
                    ...
                    <div className="mail-list mt-4 rounded">
                      <Link to="/email-inbox" className="list-group-item active">
                        ...
                        Inbox
                        <span className="badge badge-danger badge-sm float-end">198</span>
                      </Link>
                      ...
                      <Link to="/email-read" className="list-group-item">
                        ...
                        Important
                        <span className="badge badge-danger badge-sm text-white float-end">47</span>
                      </Link>
                      <Link to="/email-read" className="list-group-item">
                      ...
                      <div className="read-content">
                        <div className="media pt-3 d-sm-flex d-block justify-content-between">
                          <div className="clearfix mb-3 d-flex">
                            <img className="me-3 rounded" width="50" alt="" src={profileImage} />
                          ...
                          <div className="clearfix mb-3">
                            ...
                            <Link to="/email-read" className="btn btn-primary px-3 light ms-2">
                        ...
                        <div className="media mb-2 mt-3">
                          <div className="media-body">
                            <span className="pull-end">08:23 AM</span>
                        ...
                        <button className="btn btn-primary btn-sm ">
                          <i className="fa-solid fa-forward me-1" />
                          Forward
                        </button>
                        <hr />
