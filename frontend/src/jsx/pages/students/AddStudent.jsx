                ...
                <div className="row">
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Enter_First_Name">
                        First Name
                      </label>
                      <input
                        id="Enter_First_Name"
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Enter_Last_Name">
                        Last Name
                      </label>
                      <input
                        id="Enter_Last_Name"
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Registration Date" className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Roll_No">
                        Roll No.
                      </label>
                      <input
                        id="Roll_No"
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Parents_Name">
                        Parents Name
                      </label>
                      <input
                        id="Parents_Name"
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Parents_Mobile_Number">
