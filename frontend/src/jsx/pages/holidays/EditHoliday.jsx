                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Holiday Start Date" className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Holiday End Date" className="picker-suit" />
                        <div className="icon">
                          <i className="far fa-calendar" />
                        </div>
                      </div>
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12">
                    <div className="form-group">
                      <label className="form-label" htmlFor="Holiday_Details">
                        Holiday Details
                      </label>
                      <textarea
                        id="Holiday_Details"
