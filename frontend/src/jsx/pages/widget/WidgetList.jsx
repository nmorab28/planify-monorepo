...
const MediaProfile = ({ name }) => {
  return (
    <div className="media-body">
      ...
      <small className="d-block">29 Dec 2023 - 02:26 PM</small>
    </div>
  );
};
...
const dataListBlog = [
  {
    title: 'Allergies',
    subtitle: 'Penicilin, peanuts ',
    title2: 'Dr Theodore Handle',
    subtitle2: 'Dentist',
    title3: 'Registartion',
    subtitle3: '1',
  },
  {
    title: 'Pressure',
    subtitle: '120/100 mmHG',
    title2: 'Dr Valentino Morose',
    subtitle2: 'Surgeon',
    title3: 'Lab',
    subtitle3: '3',
  },
  ...
  },
  {
    title: 'Temperture',
    subtitle: '34 Degree',
    title2: 'Dr Eric Widget',
    subtitle2: 'Cardiology',
    title3: 'Mri',
    subtitle3: '2',
  },
];
      ...
      <Row>
        <Col xl={4} lg={12}>
          <Card>
            ...
            <div className="card-body p-0">
              <div
                id="DZ_W_TimeLine"
                className="widget-timeline dz-scroll my-4 px-4"
                style={{ height: '370px' }}
              >
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        ...
                        <small className="d-block">29 July 2023 - 02:26 PM</small>
                      </div>
                      <DropDownBlog color={'info'} />
                    </div>
                  </li>
                ...
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Alfie Mason <small className="text-muted">29 July 2023</small>
                        </h5>
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Jacob Tucker <small className="text-muted">29 July 2023</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Jack Ronan <small className="text-muted">29 July 2023</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Noah Baldon <small className="text-muted">29 July 2023</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Oscar Weston <small className="text-muted">29 July 2023</small>
                        </h5>
                        <p className="mb-1">I shared this on my fb wall a few months back..</p>
                        <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                          Reply
                ...
                <ul className="timeline">
                  {todoList.map((item, ind) => (
                    <li key={ind}>
                      <div className="timeline-panel">
                        <div
                          className={`form-check custom-checkbox check-lg me-3 checkbox-${item.color}`}
                        >
                          <input
                            type="checkbox"
                            className="form-check-input"
                            id={`customCheckBox${ind + 20}`}
                            required=""
                          />
                          <label
                            className="form-check-label"
                            htmlFor={`customCheckBox${ind + 20}`}
                          />
                        </div>
                        <div className="media-body">
                        ...
                        <Dropdown className="dropdown">
                          <Dropdown.Toggle
                            variant=""
                            className={`btn light sharp i-false p-0 sharp btn-${item.color}`}
                          >
                            <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                              <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
            ...
            <ul className="list-group list-group-flush style-4">
              ...
              {dataListBlog.map((data, index) => (
                <li
                  ...
                  key={index}
                >
                  <span className="mb-0">{data.title2} :</span>
                  <strong>{data.subtitle2}</strong>
                </li>
              ))}
            </ul>
          </div>
        ...
        <Col xl={4} lg={6} xxl={4} sm={6}>
          <div className="card text-white bg-success text-black">
            <ul className="list-group list-group-flush style-4">
              <li className="list-group-item d-flex justify-content-between text-white">
                <span className="mb-0">Stations</span>
              ...
              {dataListBlog.map((data, index) => (
                <li
                  ...
                  key={index}
                >
                  <span className="mb-0">{data.title3} :</span>
                  <strong>{data.subtitle3}</strong>
                </li>
              ))}
            </ul>
          </div>
                  ...
                  <tbody>
                    {paymentTable.map((item, ind) => (
                      <tr key={ind}>
                        ...
                        <td>{item.date}</td>
                        <td>
                          <span className={`badge badge-rounded badge-${item.color}`}>
                            {item.status}
                          </span>
                        </td>
                        <td>{item.bills}</td>
