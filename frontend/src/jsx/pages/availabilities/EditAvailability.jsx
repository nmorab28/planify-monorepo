...
const EditAvailability = () => {
    ...
    useEffect(() => {
        ...
        const loadAll = async () => {
            try {
                const [availability, teachers] = await Promise.all([
                    getAvailabilityById(documentId),
                    getTeachers()
                ]);
                ...
                if (!availability || !availability.documentId) {
                    navigate("/all-availabilities");
                    return;
                }
                ...
                setFormData({
                    ...
                    dayOfWeek:
                        dayOptions.find(o => o.value === availability.dayOfWeek) || dayOptions[0],
                    ...
                    teacher: availability.teacher
                        ? teacherOpts.find(o => o.value === availability.teacher.id) || null
                        : null
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await updateAvailability(formData.documentId, payload);
            ...
            console.error(err);
            alert(err.message || "Error actualizando disponibilidad");
        }
    };
    ...
    return (
        <>
            <PageTitle activeMenu={"Edit Availability"} motherMenu={"Availabilities"} />
            <div className="row">
