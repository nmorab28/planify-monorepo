                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker defaultValue={new Date('Feb 2 1998')} className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-group pass-group">
                        ...
                        <span
                          className={`input-group-text pass-handle ${changeText ? 'active' : ''}`}
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-group pass-group">
                        ...
                        />
                        <span
                          className={`input-group-text pass-handle ${showPassword ? 'active' : ''}`}
