  ...
  return (
    <>
            ...
            <div className="col-lg-12">
              <div className="card overflow-hidden">
                <div
                  ...
                  style={{ backgroundImage: `url(${IMAGES.BigImg1})` }}
                >
                ...
                <ul className="list-group list-group-flush">
                  {socialDetail.map((data, index) => (
                    <li className="list-group-item d-flex justify-content-between" key={index}>
                      <span className="mb-0">{data.name}</span>{' '}
                      <strong className="text-muted">{data.number}</strong>
                    </li>
                  ))}
                </ul>
                <div className="card-footer text-center border-0 mt-0">
                  <Link to={'#'} className="btn btn-primary  px-4 me-1">
                    Follow
                  </Link>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  {ProgressBar.map((item, ind) => (
                    <Fragment key={ind}>
                      <h6 className={`${item.space}`}>
                        {item.title}
                        <span className="pull-right">{item.percent}</span>
                      </h6>
                      <div className="progress ">
                        <div
                          className={`progress-bar progress-animated bg-${item.color}`}
                            ...
                            <div className="profile-about-me">
                              <div className="pt-4 border-bottom-1 pb-4">
                                <p>
                                  ...
                                  I am alone, and feel the charm of existence was created for the
                                ...
                                <div className="row mb-4" key={ind}>
                                  <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                                    <h5 className="f-w-500">
                                      {item.title} <span className="pull-right">:</span>
                                    </h5>
                                  </div>
                            ...
                            <div className="my-post-content pt-3">
                              ...
                              <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                ...
                                <Link to={'/post-details'} className="post-title">
                                  <h3>
                                    "Embark on a Journey of Unparalleled Excellence, Where
                              ...
                              <div className="profile-uoloaded-post pb-3">
                                <img
                                  src={IMAGES.Profile10}
                                  alt=""
                                  className="img-fluid w-100 rounded"
                                />
                                <Link to={'/post-details'} className="post-title">
                                  <h3>
                                    "Breakthrough Study Reveals Promising New Treatment Strategy for
                                    Alzheimer's Disease
                                  </h3>
                                </Link>
                                <p>
      ...
      >
        ...
        <div className="modal-body">
          <Link to={'#'} className="btn-social me-1 facebook mb-1">
            <i className="fab fa-facebook-f" />
          </Link>
          <Link to={'#'} className="btn-social me-1 google-plus mb-1">
            <i className="fab fa-google-plus-g" />
          </Link>
          <Link to={'#'} className="btn-social me-1 linkedin mb-1">
            <i className="fab fa-linkedin" />
          </Link>
          <Link to={'#'} className="btn-social me-1 instagram mb-1">
            <i className="fab fa-instagram" />
          </Link>
          <Link to={'#'} className="btn-social me-1 twitter mb-1">
            <i className="fab fa-twitter" />
          </Link>
          <Link to={'#'} className="btn-social me-1 youtube mb-1">
            <i className="fab fa-youtube" />
          </Link>
          <Link to={'#'} className="btn-social whatsapp mb-1">
