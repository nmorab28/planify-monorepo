    ...
    <>
      ...
      <div className="row">
        <div className="col-xl-12">
          <Link to={'/email-template'} type="submit" className="btn btn-sm btn-primary mb-4">
            List Email Template
          </Link>
        </div>
        <div className="col-xl-12">
          <div className="filter cm-content-box box-primary">
            <div className="content-title" onClick={() => setCollapseBtn(!collapseBtn)}>
              <div className="cpa">
                      ...
                      <form>
                        <div className="mb-3">
                          ...
                          <div className="form-text">
                            Title should be meaning full like : registration email, forgot password
                            email.
                          </div>
                        </div>
                        <div className="mb-3">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="new-scroll">
                          ...
                          <div className="d-grid mb-3">
                            ...
                            <span>
                              #MESSAGE#: Delivery details or expected deliery date. This message
                    ...
                    <div className="col-xl-12">
                      <div className="mb-3">
                        ...
                        <div className="form-text mb-3">
                          This design will show in recieved email and place holders will replace
