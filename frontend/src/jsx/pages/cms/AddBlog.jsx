        ...
        <div className="col-xl-12">
          <div className="mb-4">
            <ul className="d-flex align-items-center flex-wrap">
              ...
              <li>
                <Link to={'/blog-category'} className="btn btn-sm btn-primary mx-1">
                  Blog Category
                </Link>
              </li>
              <li>
                <Link to={'/blog-category'} className="btn btn-sm btn-primary me-1 mt-sm-0 mt-1">
                  Add Blog Category
                </Link>
              </li>
              <li>
                <Link
                  to={'#'}
                  className="btn btn-sm btn-primary open mt-1 mt-md-0"
          ...
          <div className="row">
            <div className="col-xl-8 col-xxl-12">
              ...
              {!state.section0 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase0' })}>
                    ...
                    <div className="cm-content-body publish-content form excerpt">
                      <div className="card-body">
                        <div className="mb-3">
                          ...
                          <div className="form-text">Excerpts are optional. </div>
                        </div>
                      </div>
                    </div>
                  </Collapse>
              ...
              {!state.section2 && (
                <div className="filter cm-content-box box-primary">
                  <div className={`content-title`} onClick={() => dispatch({ type: 'collpase2' })}>
              ...
              {!state.section3 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase7' })}>
              ...
              {!state.section4 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase8' })}>
              ...
              {!state.section5 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase9' })}>
            ...
            <div className="col-xl-4 col-xxl-12">
              {!state.section6 && (
                <div className="filter cm-content-box box-primary">
                  <div className={`content-title`} onClick={() => dispatch({ type: 'collpase3' })}>
                      ...
                      <div className="card-body py-3">
                        <ul className="list-style-1 block">
                          <li>
                            <div>
                              <label className="form-label mb-0 me-2">
                                <i className="fa-solid fa-key" /> Status:
                              </label>
                              <span className="font-w500">Published</span>
                              <Link
                                to={'#'}
                                className="badge badge-primary light ms-3"
                                id="headingOne"
                          ...
                          <li>
                            <div>
                              <label className="form-label mb-0 me-2">
                                <i className="fa-solid fa-eye" /> Status:
                              </label>
                          ...
                          <li className="border-bottom-0">
                            <div>
                              <label className="form-label mb-0 me-2">
                                <i className="fas fa-calendar-alt" /> Published on :
                              </label>
                                  ...
                                  <div className="p-3 mt-3 border rounded">
                                    <div className="input-hasicon">
                                      <input
                                        type="date"
                                        name="datepicker"
                                        className=" form-control bt-datepicker solid"
                                      />
                                    </div>
                                    <div className="mt-3">
                                      <button className="btn btn-primary btn-sm">Ok</button>{' '}
              ...
              {!state.section7 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase4' })}>
                      ...
                      <div className="card-body">
                        <div className="border p-3 mb-3">
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault-10">
                              Food
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault-11">
                              Beauty
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault-12">
                              Fashion
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault-13">
                              Lifestyle
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault-14">
                              Food
                            </label>
                          </div>
                        </div>
              ...
              {!state.section8 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase5' })}>
              ...
              {!state.section9 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase6' })}>
                          ...
                          <div className=" position-relative ">
                            ...
                            <div className="change-btn d-flex align-items-center flex-wrap">
                              <input
                                ...
                                className="d-none"
                              />
                              <label for="imageUpload" className="btn btn-primary ms-0">
                                Select Image
                              </label>
                            </div>
                          </div>
