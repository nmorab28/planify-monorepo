    ...
    <>
      ...
      <div className="row">
        <div className="col-xl-12">
          <div>
            <Link to={'/content'} className="btn btn-sm btn-primary mb-4">
              Content List
            </Link>{' '}
            <button
              type="submit"
              className="btn btn-sm btn-primary mb-4 open"
          ...
          <div className="row">
            <div className="col-xl-8">
                  ...
                  <Collapse in={!state.collpase1}>
                    <div className="cm-content-body form excerpt">
                      <div className="card-body">
                        ...
                        <button type="submit" className="btn btn-primary btn-sm mt-3 mt-sm-0">
                          Add Custom Field
                        </button>
                        <p className="mt-3 mb-0">Custom fields.</p>
                      </div>
                    </div>
                  </Collapse>
                </div>
              ...
              {!state.section3 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title" onClick={() => dispatch({ type: 'collpase10' })}>
                    <div className="cpa">Slug</div>
                    <div className="tools">
                      <Link to={'#'} className={` ${state.collpase10 ? 'expand' : 'collapse'}`}>
                        <i className="fas fa-angle-up"></i>
                      </Link>
                    </div>
                  </div>
                        ...
                        <div className="avatar-upload d-flex align-items-center">
                          <div className=" position-relative ">
                            ...
                            <div className="change-btn d-flex align-items-center flex-wrap">
                              ...
                              <label
                                htmlFor="imageUpload"
                                className="btn btn-sm btn-primary light ms-0"
                              >
                                Select Image
                              </label>
                            </div>
