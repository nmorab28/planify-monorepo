...
const Blog = () => {
  ...
  const [data, setData] = useState(document.querySelectorAll('#blog_wrapper tbody tr'));
  const sort = 8;
      ...
      <div className="row">
        <div className="col-xl-12">
          <div className="filter cm-content-box box-primary">
            <div className={`content-title`} onClick={() => setOpen(!open)}>
              <div className="cpa">
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-xl-3 col-sm-6 align-self-end">
                      <button
                        className="btn btn-primary me-2 rounded-sm"
                      ...
                      <button
                        className="btn btn-danger light rounded-sm"
          ...
          <div className="mb-4 pb-3">
            <ul className="d-flex align-items-center flex-wrap">
              <li>
                <Link to={'/add-blog'} className="btn btn-sm btn-primary ">
                  Add Blog
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={'/blog-category'} className="btn btn-sm btn-primary mt-sm-0 mt-1">
                  Add Blog Category
                </Link>
              </li>
            </ul>
