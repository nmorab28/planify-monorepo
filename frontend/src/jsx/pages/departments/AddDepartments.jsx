            ...
            <div className="card-body">
              <form action="#" method="post">
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label htmlFor="Head_Of_Department" className="form-label">
                        Head Of Department
                      </label>
                      <input
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <div className="input-hasicon mb-xl-0 mb-3">
                        <DatePicker placeholder="Department Start Date" className="picker-suit" />
                        <div className="icon">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label htmlFor="Student_Capacity" className="form-label">
                        Student Capacity
                      </label>
                      <input
                        id="Student_Capacity"
