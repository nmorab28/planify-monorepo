              ...
              <Row className="justify-content-between">
                ...
                <Col xl={4} xxl={12}>
                  <div className="mb-4">
                    ...
                    <p>
                      Use tags <code>text-start, text-center, text-end</code> for get desire text.
                    </p>
                  </div>
                  <div className="card-content">
                ...
                <Col lg={6}>
                  <div className="mb-4">
                    ...
                    <p>
                      Use tags{' '}
                      <code>text-sm-start, text-md-start, text-lg-start, text-xl-start</code> for
                      get desire text.
                    </p>
                  </div>
                  <div className="card-content">
                ...
                <Col lg={6}>
                  <div className="mb-4">
                    ...
                    <p>
                      Use tags <code>fw-bold, fw-normal, fst-italic</code> for get desire text.
                    </p>
                  </div>
                  <div className="card-content">
