...
const UiModal = () => {
  ...
  return (
    <div className="h-80">
      <PageTitle pageContent="Modal" motherMenu={'Bootstrap'} activeMenu={'Modal'} />
      <Row>
        <Col>
          <Card>
            <Card.Header>
            ...
            <Card.Body>
              ...
              <div className="bootstrap-modal">
                ...
                <Button variant="primary" className="mb-2 me-2" onClick={() => setBasicModal(true)}>
                  Basic modal
                </Button>
                {/* <!-- Modal --> */}
                ...
                {/* <!-- Large modal --> */}
                <Button variant="primary" className="mb-2 me-2" onClick={() => setLargeModal(true)}>
                  Large modal
                </Button>
                <Modal
                ...
                {/* <!-- Small modal --> */}
                <Button variant="primary" className="mb-2 me-2" onClick={() => setSmallModal(true)}>
                  Small modal
                </Button>
                <Modal
