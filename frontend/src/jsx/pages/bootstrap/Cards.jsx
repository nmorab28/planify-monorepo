        ...
        <Col xl="6">
          <Card className="text-white bg-secondary card-ui-default-1">
            ...
            <Card.Body className=" mb-0">
              ...
              <Button as="a" variant=" " href="#" className="btn-card bg-white text-secondary mt-3">
                Go somewhere
              </Button>
            </Card.Body>
            <Card.Footer className=" bg-transparent border-0 text-white">
        ...
        <Col xl="6">
          <Card className="text-white bg-success">
            ...
            <Card.Body className=" mb-0">
              ...
              <Button as="a" variant=" " href="#" className="btn-card bg-white text-success mt-3">
                Go somewhere
              </Button>
            </Card.Body>
            <Card.Footer className=" bg-transparent border-0 text-white">
        ...
        <Col xl="6">
          <Card className="">
            ...
            <Card.Body>
              ...
              <Card.Text className="mt-3 text-dark">Last updated 3 mins ago</Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col xl="6">
