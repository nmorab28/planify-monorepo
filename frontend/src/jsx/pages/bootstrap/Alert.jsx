          ...
          <Card>
            ...
            <Card.Body>
              <Alert variant="primary" dismissible show={state.primary}>
                {emojis.welcome} <strong>Welcome! </strong> Message has been sent.
                <button
                  className="btn-close"
              ...
              <Alert variant="secondary" dismissible show={state.secondary}>
                {emojis.done} <strong>Done! </strong> Your profile photo updated.
                <button
                  className="btn-close"
              ...
              <Alert variant="success" dismissible show={state.success}>
                {emojis.success} <strong>Success! </strong> Message has been sent.
                <button
                  className="btn-close"
              ...
              <Alert variant="info" dismissible show={state.info}>
                {emojis.info} <strong>Info! </strong> You have got 5 new email.
                <button className="btn-close" onClick={() => dispatch({ type: 'info' })}></button>
              </Alert>
              <Alert variant="warning" dismissible show={state.warning}>
                {emojis.warning} <strong>Warning! </strong> Something went wrong. Please check.
                <button
                  className="btn-close"
          ...
          <Card>
            ...
            <Card.Body>
              <Alert variant="primary" dismissible show={state.linksolidprimary} className="solid">
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksolidprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.linksolidsecondary}
                className="solid"
              >
                <strong>WOW! </strong> Eveything looks OK.
                <Link to={'#'} className="badge-sm light ms-1 badge badge-secondary">
                  upgrade
                </Link>
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksolidsecondary' })}
                ></button>
              </Alert>
              <Alert variant="success" dismissible show={state.linksolidsuccess} className="solid">
                <strong>WOW! </strong> Eveything looks OK.
                <Link to={'#'} className="badge-sm light ms-1 badge badge-succes">
                  upgrade
                </Link>
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksolidsuccess' })}
                ></button>
              </Alert>
              <Alert variant="info" dismissible show={state.linksolidinfo} className="solid">
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksolidinfo' })}
                ></button>
              </Alert>
              <Alert variant="warning" dismissible show={state.linksoliddanger} className="solid">
                <strong>Warning! </strong> Eveything looks OK.
                <Link to={'#'} className="badge-sm light ms-1 badge badge-warning">
                  upgrade
                </Link>
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksoliddanger' })}
                ></button>
              </Alert>
              <Alert variant="danger" dismissible show={state.linksoliddark} className="solid">
                <strong>Error! </strong> Eveything looks OK.
                <Link to={'#'} className="badge-sm light ms-1 badge badge-danger">
                  upgrade
                </Link>
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksoliddark' })}
                ></button>
              </Alert>
              <Alert variant="dark" dismissible show={state.linksolidlight} className="solid">
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linksolidlight' })}
                ></button>
              </Alert>
              <Alert variant="light" dismissible show={state.linklinklight} className="solid">
                <strong>Error! </strong> Eveything looks OK.
                <Link to={'#'} className="badge-sm light ms-1 badge badge-light">
                  upgrade
                </Link>
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'linklinklight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
              ...
              <Row>
                <Col xl={6}>
                  <Alert variant="primary" className="notification">
                    <p className="notificaiton-title mb-2">
                      <strong>Done!</strong> Vampires The Romantic Ideology Behind Them
                    </p>
                    <p>
                ...
                <Col xl={6}>
                  <Alert variant="info" className="notification">
                    <p className="notificaiton-title mb-2">
                      <strong>Info!</strong> Vampires The Romantic Ideology Behind Them
                    </p>
                    <p>
                      The following article covers a topic that has recently moved to center
                      stage-at lease it seems that way.
                ...
                <Col xl={6}>
                  <Alert variant="warning" className="notification">
                    <p className="notificaiton-title mb-2">
                      <strong>Warning!</strong> Vampires The Romantic Ideology Behind Them
                    </p>
                    <p>
                      The following article covers a topic that has recently moved to center
                      stage-at lease it seems that way.
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Alert
                variant="info"
                dismissible
                show={state.outlineinfo}
                className="alert-outline-info"
              >
                Info! You have got 5 new email.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlineinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
              ...
              <Row>
                ...
                <Col xl={6}>
                  ...
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagesecondary' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
