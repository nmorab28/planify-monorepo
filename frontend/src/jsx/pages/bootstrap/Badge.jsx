...
const UiBadge = () => {
  return (
    <div className="badge-demo">
      <PageTitle motherMenu="Bootstrap" activeMenu="Badge" pageContent="Badge" />
      <Row>
        <Col lg="6">
          <Card>
        ...
        <Col lg="6">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                <Badge bg="primary">Pill badge</Badge> <Badge bg="secondary">Pill badge</Badge>{' '}
                <Badge bg="success">Pill badge</Badge> <Badge bg="danger">Pill badge</Badge>{' '}
                <Badge bg="warning">Pill badge</Badge> <Badge bg="info">Pill badge</Badge>{' '}
                <Badge bg="light" className="text-bg-light">
                  Pill badge
                </Badge>{' '}
