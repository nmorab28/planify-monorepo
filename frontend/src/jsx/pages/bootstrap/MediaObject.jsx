          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-media">
                <div className="media">
                  <img className="me-3 img-fluid " width="60" src={avatar1} alt="DexignZone" />
                ...
                <div className="media mt-4">
                  <img className="me-3 img-fluid " width="60" src={avatar7} alt="DexignZone" />
                  <div className="media-body">
                    <h5 className="mt-0">{heading}</h5>
                    <p className="mb-0">{text}</p>
                  </div>
        ...
        <Col xl="6" lg="12">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-media">
                <div className="media">
                  <img className="me-3 " width="60" src={avatar2} alt="DexignZone" />
                  <div className="media-body">
                    <h5 className="mt-0">{heading}</h5>
                    <p className="mb-0">{text}</p>
        ...
        <Col xl="6" lg="12">
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-media">
                <div className="media">
                  <img className="align-self-end me-3 " width="60" src={avatar6} alt="DexignZone" />
                  <div className="media-body">
            ...
            <Card.Body>
              <div className="bootstrap-media">
                <div className="media">
                  ...
                  <img className="ms-3 " width="60" src={avatar7} alt="DexignZone" />
                </div>
              </div>
            </Card.Body>
          </Card>
            ...
            <Card.Body>
              <div className="bootstrap-media">
                <ul className="list-unstyled">
                  <li className="media">
                    <img className="me-3 " width="60" src={avatar8} alt="DexignZone" />
                    <div className="media-body">
                  ...
                  <li className="media my-4">
                    <img className="me-3 " width="60" src={avatar1} alt="DexignZone" />
                    <div className="media-body">
                      <h5 className="mt-0">List-based media object</h5>
                      <p className="mb-0">{text2}</p>
                    </div>
