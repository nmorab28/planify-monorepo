          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="profile-lang pt-5 border-bottom-1 pb-5">
                ...
                <Link to={'#'} className="badge badge-primary light me-1">
                  <i className="flag-icon flag-icon-us" /> English
                </Link>
                <Link to={'#'} className="badge badge-primary light me-1">
                  <i className="flag-icon flag-icon-fr" /> French
                </Link>
                <Link to={'#'} className="badge badge-primary light">
              ...
              <ul className="list-group mb-3 list-group-flush">
                ...
                <li className="list-group-item -0 px-0">
                  It has survived not only five centuries, but also the leap into electronic
                  typesetting, remaining essentially unchanged. It was popularised in the 1960s with
                ...
                <li className="list-group-item -0 px-0">
                  ...
                  charm of existence was created for the bliss of souls like mine.
                </li>
                <li className="list-group-item -0 px-0">
