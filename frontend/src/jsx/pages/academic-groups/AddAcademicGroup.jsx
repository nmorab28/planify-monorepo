...
const AddAcademicGroup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await createAcademicGroup(payload);

            if (!res || res.error) {
                throw new Error("Error en Strapi");
            }

            alert("Grupo académico creado correctamente");
            navigate("/all-academic-groups");

        } catch (err) {
            console.error(err);
            alert(err.message || "Error creando grupo académico");
        }
    };

    return (
        <>
            <PageTitle activeMenu={"Add Academic Group"} motherMenu={"Academic Groups"} />
            <div className="row">
                <div className="col-xl-12 col-xxl-12 col-sm-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit} id="addAcademicGroupForm">
                                <div className="row">
...
export default AddAcademicGroup;
