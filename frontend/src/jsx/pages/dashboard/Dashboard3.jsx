          ...
          <div className="widget-stat card bg-danger overflow-hidden">
            ...
            <div className="card-body p-0 mt-1">
              ...
              >
                <SparklinesLine
                  color="#fff"
                  style={{ strokeWidth: 1.5, fill: '#fff', fillOpacity: '.1' }}
                />
              </Sparklines>
            </div>
          </div>
                  ...
                  <tbody id="customers">
                    {studentTable.map((data, i) => (
                      <tr className="btn-reveal-trigger" key={i}>
                        ...
                        <td>
                          <span className={`badge badge-rounded badge-${data.color}`}>
                            {data.status}
                          </span>
                        </td>
                        <td className="py-2">{data.date}</td>
                        <td>
                          <Link to={'/edit-student'} className="btn btn-xs sharp btn-primary me-1">
                            <i className="fa fa-pencil" />
                          </Link>
                          <Link to={'#'} className="btn btn-xs sharp btn-danger">
