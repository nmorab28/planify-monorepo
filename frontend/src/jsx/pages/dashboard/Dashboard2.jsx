      ...
      <Row>
          ...
          <div className="card">
                ...
                <div className="media mb-3 align-items-center border-bottom pb-3" key={ind}>
                  ...
                  <div className="media-body">
                    <h5 className="mb-0 text-pale-sky">
                      {item.name} <small className="text-muted">( {item.subject} )</small>
                    </h5>
                    <small
                      className={`mb-0 text-${item.status === 'Available' ? 'primary' : 'danger'}`}
                    >
                      {item.status}
                    </small>
                  </div>
            ...
            <div className="card-footer border-0 pt-2">
              <div className="text-center">
                <Link to={'/all-professors'} className="btn btn-primary">
                  View All
                </Link>
              </div>
            </div>
          ...
          <div className="card">
            <div className="card-header">
              ...
              <small className="text-success">
                <i className="fa fa-caret-up" /> 20% High then last mont
              </small>
            </div>
        ...
        <Col xl={'4'} lg={'4'} xxl={'4'} md={'6'}>
          <div className="card">
            ...
            <div className="chart-wrapper">
              <Sparklines
                className="peity-line-3"
                data={[3, 8, 3, 7, 8, 6, 3, 4, 7, 3, 7, 9, 6, 3, 7, 6, 7, 3, 4, 2]}
              >
            ...
            <div className="card-body custom-tab-1">
              <Tab.Container defaultActiveKey="Posts">
                <Nav as="ul" className="nav-tabs mb-3">
                  <Nav.Item as="li">
                    <Nav.Link eventKey="Posts" className="pb-2">
                      Professors
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link eventKey="Library" className="pb-2">
                      Librarian
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link eventKey="Other" className="pb-2">
                      Other
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
