...
const LIST_POPULATE = "populate[teacher]=true";

export const getAvailabilities = async () => {
  const res = await fetch(`${API_URL}/api/availabilities?${LIST_POPULATE}`, {
    method: "GET",
...
export const getAvailabilityById = async (documentId) => {
  const res = await fetch(
    `${API_URL}/api/availabilities/${documentId}?${LIST_POPULATE}`,
    {
      method: "GET",
      headers: getAuthHeaders(),
    }
...
export const updateAvailability = async (documentId, availability) => {
